...
public class InstructorSignInView extends JFrame {
    public JFrame MainFrame = new JFrame();
    TestPanel gradientPanel = new TestPanel();
    public RoundedPanel SignInButton, SignInLabel, loginPanel;
    public JLabel homeLabel, signInLabel, greetingLabel2, studentSignUpLogo, ___username, ___password, signInlabelButton, signUpLabelBOLD;
    public JTextField usernameTextF;
    public JPasswordField passwordTextF;

    //Constructor
    public InstructorSignInView() {
        InstructorSignInView();
    }
    //Gradient Panel
    ...
    public void InstructorSignInView() {
        MainFrame.setSize(1000, 600);
        MainFrame.setTitle("Instructor Sign-In");
        ...
        greetingLabel2 = new JLabel("INSTRUCTOR");
        greetingLabel2.setForeground(new Color(253,208,72,255));
        greetingLabel2.setBounds(110,80,150,40);
        greetingLabel2.setFont(new Font("Segoe UI", Font.BOLD,23));

        ImageIcon instructorIcon = new ImageIcon(getClass().getResource("icons\\instructorBILOG.png"));
        studentSignUpLogo = new JLabel(instructorIcon);
        studentSignUpLogo.setBounds(0,65,150,70);

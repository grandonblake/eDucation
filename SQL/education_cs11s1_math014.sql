...
--
-- Table structure for table `cs11s1_math014`
--

DROP TABLE IF EXISTS `cs11s1_math014`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cs11s1_math014` (
...
--
-- Dumping data for table `cs11s1_math014`
--

LOCK TABLES `cs11s1_math014` WRITE;
/*!40000 ALTER TABLE `cs11s1_math014` DISABLE KEYS */;
INSERT INTO `cs11s1_math014` VALUES (9,'vicent','INCOMPLETE',NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL,NULL),(13,'juan','COMPLETE',30,20,15,20,10,14,48,92,30,25,15,25,10,15,50,100);
/*!40000 ALTER TABLE `cs11s1_math014` ENABLE KEYS */;
UNLOCK TABLES;

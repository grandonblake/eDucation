...
--
-- Table structure for table `cs11s1_cs002`
--

DROP TABLE IF EXISTS `cs11s1_cs002`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `cs11s1_cs002` (
...
--
-- Dumping data for table `cs11s1_cs002`
--

LOCK TABLES `cs11s1_cs002` WRITE;
/*!40000 ALTER TABLE `cs11s1_cs002` DISABLE KEYS */;
INSERT INTO `cs11s1_cs002` VALUES (34,'vicent','COMPLETE',5,10,20,10,12,14,49,100,5,10,20,10,13,15,50,100),(42,'juan','COMPLETE',20,15,10,10,8,12,45,97,20,15,15,10,10,15,50,100);
/*!40000 ALTER TABLE `cs11s1_cs002` ENABLE KEYS */;
UNLOCK TABLES;
